  ...
  return (
    <div className='box'>
        ...
        <div className='sobreMim-texto '>
            ...
            <p className='sobreMim-paragrafo '>Sou formado no Técnico em Desenvolvimento de Sistemas na escola SENAI Suíço-Brasileira “Paulo Ernesto Tolle”, em Santo Amaro e atuamente estou na faculdade da intuição Centro Universitário SENAC Santo Amaro estando atualmente no 2° semestre de Análise e Desenvolvimento de Sistemas.</p>
